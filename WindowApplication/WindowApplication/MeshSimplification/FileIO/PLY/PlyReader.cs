using MeshSimplification.FileIO;
using System;
                ...
                case "vertex":
                    {
                        ...
                        while (cnt < e.CountInFile)
                        {
                            ...
                            foreach (Property p in e.Properties)
                            {
                                ...
                                {
                                    case "x":
                                        x = GetDouble(p.ElementSize);
                                        break;
                                    case "y":
                                        y = GetDouble(p.ElementSize);
                                        break;
                                    case "z":
                                        z = GetDouble(p.ElementSize);
                                        break;
                                    default:
                                        SkipProperty(p);
                                        break;
        ...
        bool IsTriangular(int size)
        {
            switch (size)
            {
                case 1:
                    ...
                    break;
                case 2:
                    if (reader.ReadInt16() != 3) return false;
                    break;
                case 4:
                    if (reader.ReadInt32() != 3) return false;
                    break;
                case 8:
                    if (reader.ReadInt64() != 3) return false;
                    break;
